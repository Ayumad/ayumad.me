...
export const aboutContent: AboutContent = {
  ...
  story: [
    ...
    "Most of my projects start with a practical question. Can an old ThinkStation be a real server? Yes — it's a Proxmox host now, 16 TB of ZFS and an RTX 3060 passed through to a VM for local AI. Can one Mac mini run an AI agent for my entire life? Also yes — daily briefs, memory, 15 scheduled automations, all routed between cheap models so it costs less than a streaming subscription. I don't buy new hardware. New stuff just works, and where's the fun in that? Old stuff needs convincing, and I like being the one who convinces it.",
    "I study Computer Engineering at San José State, after Computer Science at Foothill, where I ran the Data Science & AI club and started Principia STEM Magazine. I've shipped a chatbot for Foothill students, an emotion-aware bot at CalHacks, and an audio-visualization project that became a magazine article. None of it went perfectly, and most of it is documented in a git-backed Obsidian vault because I got tired of forgetting what I did and why.",
