...
The ranked table, with the panel each machine actually drives:

| Machine | GPU | Rel. speed | Panel it drives |
| --- | --- | --- | --- |
...
| [ROG Ally](/gear/gaming-asus-rog-ally) | Z1 Extreme | 26 | 1080p 120 Hz VRR |
